...
public class TeleporterEtherealportal  extends Teleporter{
    ...
    public TeleporterEtherealportal(WorldServer worldServer) {
        super(worldServer);
    ...
    public boolean placeInExistingPortal(Entity entity, double par2, double par4, double par6, float par8)
    {
        ...
        {
            TeleporterEtherealportal.PortalPosition portalposition =(Teleporter.PortalPosition)this.destinationCoordinateCache.getValueByKey(j1);
            d3 = 0.0D;
        ...
        if(d3 >= 0.0D)
        {
            if(flag)
            {
                this.destinationCoordinateCache.add(j1, new TeleporterEtherealportal.PortalPosition(i, j, k, this.worldServerInstance.getTotalWorldTime()));
